...
[![](https://jitpack.io/v/VivoMask/libsu.svg)](https://jitpack.io/#VivoMask/libsu)
...
## [Javadoc](https://VivoMask.github.io/libsu/)
...
dependencies {
    ...
    implementation "com.github.VivoMask.libsu:core:${libsuVersion}"

    // Optional: APIs for creating root services. Depends on ":core"
    implementation "com.github.VivoMask.libsu:service:${libsuVersion}"

    // Optional: Provides remote file system support
    implementation "com.github.VivoMask.libsu:nio:${libsuVersion}"
}
```
...
Add `com.github.VivoMask.libsu:nio` as a dependency to access remote file system APIs:
